...
public final class CategorySpecification {
  ...
  public CategorySpecification withUserId(String userId) {
    ...
    specifications.add((root, query, cb) -> cb.equal(root.get("user").get("id"), userId.trim()));
  ...
  public CategorySpecification withArchived(Boolean isArchived) {
    ...
    specifications.add((root, query, cb) -> cb.equal(root.get(FIELD_IS_ARCHIVED), isArchived));

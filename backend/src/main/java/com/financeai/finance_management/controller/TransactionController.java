...
public class TransactionController {
  ...
  public ResponseEntity<BaseResponse<TransactionResponse>> updateTransaction(
      @PathVariable String transactionId, @RequestBody UpsertTransactionRequest request) {
  ...
  @Operation(
      summary = "Upsert Auto Config",
      description = "Create or Update auto income/expense config")
  ...
  @Operation(
      summary = "Toggle Auto Config",
      description = "Enable or Disable an auto transaction config")
  @PatchMapping("/auto-configs/{configId}/toggle")
  public ResponseEntity<BaseResponse<Void>> toggleAutoConfig(@PathVariable String configId) {
  ...
  public ResponseEntity<BaseResponse<Void>> deleteAutoConfig(@PathVariable String configId) {

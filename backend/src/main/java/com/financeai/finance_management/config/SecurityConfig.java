...
public class SecurityConfig {
  ...
  private static final String[] PUBLIC_ENPOINTS_FOR_GET = {
    "/api/users",
    ...
    httpSecurity.authorizeHttpRequests(
        request ->
            request
                ...
                .permitAll()
                .requestMatchers(HttpMethod.POST, PUBLIC_ENPOINTS)
                .permitAll()
                .requestMatchers(HttpMethod.GET, PUBLIC_ENPOINTS_FOR_GET)
                .permitAll()
                .anyRequest()
                .authenticated());

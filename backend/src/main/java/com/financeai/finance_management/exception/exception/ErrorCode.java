package com.financeai.finance_management.exception.exception;
...
public enum ErrorCode {
  ...
  // RESTAURANT
  UNAUTHORIZED_TO_UPDATE_THIS_RESOURCE(
      "UNAUTHORIZED_001", "Unauthorized to update this resource", HttpStatus.UNAUTHORIZED),
  ...
  DISH_SERVING_STOPPED(
      "DISH_002", "This dish is no longer being served", HttpStatus.SERVICE_UNAVAILABLE),
  ...
  // BUDGET
  CANNOT_CHANGE_BUDGET_TYPE(
      "BUDGET_001", "Cannot change budget type", HttpStatus.SERVICE_UNAVAILABLE),
  ...
  CURRENT_BALANCE_NOT_ENOUGH(
      "TRANSACTION_002", "Current balance not enough", HttpStatus.BAD_REQUEST),
  ;
